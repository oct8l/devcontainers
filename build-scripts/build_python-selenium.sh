...
docker manifest create oct8l/devcontainers:python-selenium-latest --amend oct8l/devcontainers:amd64_python-selenium-latest --amend oct8l/devcontainers:arm64_python-selenium-latest
